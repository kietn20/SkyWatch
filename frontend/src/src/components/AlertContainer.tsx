        ...
        <div className="absolute bottom-6 right-6 z-[600] flex flex-col gap-3 w-80">
            {alerts.map((alert, idx) => {
                ...
                return (
                    ...
                    >
                        <div className={`mt-1 ${isEnter ? 'text-red-400 animate-pulse' : 'text-emerald-400'}`}>
                            {isEnter ? <ShieldAlert size={24} /> : <ShieldCheck size={24} />}
                        </div>
                        <div className="flex-1">
                            <div className="flex justify-between items-start">
                                ...
                                <button onClick={() => onDismiss(idx)} className="opacity-50 hover:opacity-100">
                                    <X size={16} />
                                </button>
                            </div>
